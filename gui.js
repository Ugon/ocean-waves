var Gui = function(guiDiv, statsDiv){  
    ...
    params[PARAM_NAME_PHONG_BIAS_LIN]       = PARAM_INIT_PHONG_BIAS_LIN;
    ...
    var sizeParams       = gui.addFolder('Size');
	var controlParams    = gui.addFolder('Control');

    conditionsParams.add(params, PARAM_NAME_TIME_STEP           , 0, 1);
    conditionsParams.add(params, PARAM_NAME_PHILLIPS_CONST      , 0, 1);
    conditionsParams.add(params, PARAM_NAME_SMALL_WAVE_SUPPRESS , 0, 1);
    conditionsParams.add(params, PARAM_NAME_DISPLACEMENT_CONST  , 0, 1);
    conditionsParams.add(params, PARAM_NAME_WIND_X              ,-1, 1);
    conditionsParams.add(params, PARAM_NAME_WIND_Y              ,-1, 1);

    sizeParams.add(params, PARAM_NAME_SIZE_CALC           , 0, 1);
    sizeParams.add(params, PARAM_NAME_SCALE_HORIZONTAL    , 0, 1);
    sizeParams.add(params, PARAM_NAME_SCALE_VERTICAL      , 0, 1);
    sizeParams.add(params, PARAM_NAME_NO_TILES_HORIZONTAL , 1, 5).step(1);
    sizeParams.add(params, PARAM_NAME_NO_TILES_VERTICAL   , 1, 5).step(1);
    ...
    colorParams.add(params, PARAM_NAME_PHONG_BIAS_LIN       , 0, 1);
    ...
    for(var sizeInd in PARAM_POSS_TRANSFORM_SIZE){
    	...
    	params[size] = false;
    	var ctrl = sizeParams.add(params, size, false).listen();
